                    ...
                    >
                        ...
                        <?php elseif ($config['key'] === 'hospitales' && $config['phase'] === 'pre'): ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a2 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q2" id="aq2_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq2_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a3 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q3" id="aq3_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq3_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a4 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q4" id="aq4_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq4_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a5 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q5" id="aq5_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq5_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                <p class="fw-semibold mb-1">
                                    ...
                                    mejor estrategia para detectar consumo riesgoso en este entorno?
                                </p>
                                <div class="text-muted small mb-2">Seleccione una opción *</div>
                                <?php
                                $a6 = [
                                ...
                                foreach ($a6 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q6" id="aq6_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq6_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a7 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q7" id="aq7_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq7_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                ...
                                foreach ($a8 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q8" id="aq8_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq8_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="mb-4 app-form-question">
                                <p class="fw-semibold mb-1">
                                    ...
                                    adoptada por la Corte en esta sentencia?
                                </p>
                                <div class="text-muted small mb-2">Seleccione una opción *</div>
                                <?php
                                $a9 = [
                                ...
                                foreach ($a9 as $value => $label): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="q9" id="aq9_<?= $value ?>"
                                               value="<?= $value ?>" required>
                                        <label class="form-check-label" for="aq9_<?= $value ?>">
                                            <?= $value ?>. <?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
