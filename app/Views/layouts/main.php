    ...
    <?php if ($showSidebar): ?>
        <header class="app-topbar d-lg-none" aria-label="Menú">
            <a class="app-topbar-brand" href="/">
                <span class="app-topbar-brand-mark">
                    <img src="<?= asset_url('/assets/img/logoHomo.png') ?>" alt="Logo HOMO" class="brand-logo-homo">
                </span>
                ...
                <?php if ($showSidebar): ?>
                    <aside class="app-sidebar flex-column">
                        <div class="app-sidebar-inner">
                            <div class="app-sidebar-head">
                                <a href="/" class="app-sidebar-brand-link">
                                    <span class="app-sidebar-brand">
                                        <img src="<?= asset_url('/assets/img/logoHomo.png') ?>" alt="Logo HOMO" class="sidebar-logo-homo">
                                    </span>
                                ...
                                ?>
                                    <div class="dropdown app-sidebar-user-dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark w-100 border-0 rounded-2 shadow-lg" aria-labelledby="sidebarUserDropdown">
                                            <li>
                                                <h6 class="dropdown-header text-white-50">Sesión iniciada</h6>
                                            </li>
                                            ...
                                            <?php endif; ?>
                                            <li>
                                                <hr class="dropdown-divider dropdown-divider-dark">
                                            </li>
                                            <li class="px-2 pb-2">
                            ...
                            <div class="app-sidebar-institutional">
                                <img src="<?= asset_url('/assets/img/logoAntioquia.png') ?>" alt="Gobernación de Antioquia" class="sidebar-logo-antioquia">
                            </div>
                        </div>
                    </aside>
